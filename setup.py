...
async def build_action(actions_list, answers_list, act_name, act_func, act_alias=None):
    ...
    print("""Action {0} has been built, with alias {1}.""".format(act_name, act_alias))
...
async def setup(cert_data, actions_list, answers_list):
    ...
    cert_data["cert_metadata"]["req"]["cname"] = cert_data["cert_metadata"]["auth"]["cname"]
    cert_data["cert_metadata"]["req"]["org_name"] = cert_data["cert_metadata"]["auth"]["org_name"]
    cert_data["cert_metadata"]["req"]["org_unit_name"] = cert_data["cert_metadata"]["auth"]["org_unit_name"]
    print(cert_data)
