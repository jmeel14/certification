...
NEVER MEANT TO MODIFY YOUR FILESYSTEM (EXCEPT IN THE CONTAINING FOLDER), YOUR PHYSICAL DEVICES, YOUR LOCAL NETWORK'S STABILITY, OR ANY OTHER MISCELLANEOUS
...
- py socket (don't know if it comes pre-installed)
